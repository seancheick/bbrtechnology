...
export function ThemeToggle() {
  ...
  return (
    <div className="relative flex h-9 items-center rounded-full bg-navy-900/10 dark:bg-white/10 border border-border px-1">
      {/* Sliding indicator */}
      <motion.div
        className="absolute top-1 bottom-1 rounded-full bg-bg shadow-sm"
        initial={false}
        animate={{
          left: isDark ? "50%" : "4px",
          right: isDark ? "4px" : "50%",
